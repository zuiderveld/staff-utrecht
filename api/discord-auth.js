const { exchangeCode, verifyGuildMember } = require('./lib/discord-staff');
...
/** Discord-login voor iedereen op de URP-server (o.a. support wachtkamer) */
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const result = await verifyGuildMember(accessToken);
